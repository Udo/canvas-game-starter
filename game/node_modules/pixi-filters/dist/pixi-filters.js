/*!
 * pixi-filters - v6.0.5
 * Compiled Fri, 30 Aug 2024 18:50:49 UTC
 *
...
}`,bl=Object.defineProperty,Cl=Object.defineProperties,Tl=Object.getOwnPropertyDescriptors,Dr=Object.getOwnPropertySymbols,Pl=Object.prototype.hasOwnProperty,Ol=Object.prototype.propertyIsEnumerable,Ge=(r,e,n)=>e in r?bl(r,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):r[e]=n,$r=(r,e)=>{for(var n in e||(e={}))Pl.call(e,n)&&Ge(r,n,e[n]);if(Dr)for(var n of Dr(e))Ol.call(e,n)&&Ge(r,n,e[n]);return r},zl=(r,e)=>Cl(r,Tl(e)),Me=(r,e,n)=>(Ge(r,typeof e!="symbol"?e+"":e,n),n);const Gr=class Ot extends i.Filter{constructor(e){const{width:n,height:t}=i.ViewSystem.defaultOptions;e=$r(zl($r({},Ot.DEFAULT_OPTIONS),{start:{x:0,y:t/2},end:{x:n,y:t/2}}),e);const o=i.GpuProgram.from({vertex:{source:m,entryPoint:"mainVertex"},fragment:{source:Sl,entryPoint:"mainFragment"}}),u=i.GlProgram.from({vertex:c,fragment:yl,name:"tilt-shift-axis-filter"});super({gpuProgram:o,glProgram:u,resources:{tiltShiftUniforms:{uBlur:{value:new Float32Array([e.blur,e.gradientBlur]),type:"vec2<f32>"},uStart:{value:e.start,type:"vec2<f32>"},uEnd:{value:e.end,type:"vec2<f32>"},uDelta:{value:new Float32Array([0,0]),type:"vec2<f32>"},uDimensions:{value:new Float32Array([n,t]),type:"vec2<f32>"}}}}),Me(this,"uniforms"),Me(this,"_tiltAxis"),this.uniforms=this.resources.tiltShiftUniforms.uniforms,this._tiltAxis=e.axis}updateDimensions(e){const{uDimensions:n}=this.uniforms;n[0]=e.frame.width,n[1]=e.frame.height}updateDelta(){if(this.uniforms.uDelta[0]=0,this.uniforms.uDelta[1]=0,this._tiltAxis===void 0)return;const e=this.uniforms.uEnd,n=this.uniforms.uStart,t=e.x-n.x,o=e.y-n.y,u=Math.sqrt(t*t+o*o),l=this._tiltAxis==="vertical";this.uniforms.uDelta[0]=l?-o/u:t/u,this.uniforms.uDelta[1]=l?t/u:o/u}};Me(Gr,"DEFAULT_OPTIONS",{blur:100,gradientBlur:600});let X=Gr;var Fl=Object.defineProperty,Al=Object.defineProperties,wl=Object.getOwnPropertyDescriptors,Mr=Object.getOwnPropertySymbols,Il=Object.prototype.hasOwnProperty,Ul=Object.prototype.propertyIsEnumerable,Ee=(r,e,n)=>e in r?Fl(r,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):r[e]=n,Y=(r,e)=>{for(var n in e||(e={}))Il.call(e,n)&&Ee(r,n,e[n]);if(Mr)for(var n of Mr(e))Ul.call(e,n)&&Ee(r,n,e[n]);return r},Er=(r,e)=>Al(r,wl(e)),_l=(r,e,n)=>(Ee(r,typeof e!="symbol"?e+"":e,n),n);class Rl extends X{constructor(e){e=Y(Y({},X.DEFAULT_OPTIONS),e),super(Er(Y({},e),{axis:"horizontal"})),_l(this,"_tiltShiftYFilter"),this._tiltShiftYFilter=new X(Er(Y({},e),{axis:"vertical"})),this.updateDelta(),Object.assign(this,e)}apply(e,n,t,o){const u=i.TexturePool.getSameSizeTexture(n);this.updateDimensions(n),this._tiltShiftYFilter.updateDimensions(n),e.applyFilter(this,n,u,!0),e.applyFilter(this._tiltShiftYFilter,u,t,o),i.TexturePool.returnTexture(u)}updateDelta(){super.updateDelta(),this._tiltShiftYFilter.updateDelta()}get blur(){return this.uniforms.uBlur[0]}set blur(e){this.uniforms.uBlur[0]=this._tiltShiftYFilter.uniforms.uBlur[0]=e}get gradientBlur(){return this.uniforms.uBlur[1]}set gradientBlur(e){this.uniforms.uBlur[1]=this._tiltShiftYFilter.uniforms.uBlur[1]=e}get start(){return this.uniforms.uStart}set start(e){this.uniforms.uStart=this._tiltShiftYFilter.uniforms.uStart=e,this.updateDelta()}get startX(){return this.start.x}set startX(e){this.start.x=e,this.updateDelta()}get startY(){return this.start.y}set startY(e){this.start.y=e,this.updateDelta()}get end(){return this.uniforms.uEnd}set end(e){this.uniforms.uEnd=this._tiltShiftYFilter.uniforms.uEnd=e,this.updateDelta()}get endX(){return this.end.x}set endX(e){this.end.x=e,this.updateDelta()}get endY(){return this.end.y}set endY(e){this.end.y=e,this.updateDelta()}}var Dl=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,Gl=Object.defineProperty,Lr=Object.getOwnPropertySymbols,Ml=Object.prototype.hasOwnProperty,El=Object.prototype.propertyIsEnumerable,Le=(r,e,n)=>e in r?Gl(r,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):r[e]=n,ke=(r,e)=>{for(var n in e||(e={}))Ml.call(e,n)&&Le(r,n,e[n]);if(Lr)for(var n of Lr(e))El.call(e,n)&&Le(r,n,e[n]);return r},kr=(r,e,n)=>(Le(r,typeof e!="symbol"?e+"":e,n),n);const Br=class zt extends i.Filter{constructor(e){var n,t;e=ke(ke({},zt.DEFAULT_OPTIONS),e);const o=i.GpuProgram.from({vertex:{source:m,entryPoint:"mainVertex"},fragment:{source:$l,entryPoint:"mainFragment"}}),u=i.GlProgram.from({vertex:c,fragment:Dl,name:"twist-filter"});super(ke({gpuProgram:o,glProgram:u,resources:{twistUniforms:{uTwist:{value:[(n=e.radius)!=null?n:0,(t=e.angle)!=null?t:0],type:"vec2<f32>"},uOffset:{value:e.offset,type:"vec2<f32>"}}}},e)),kr(this,"uniforms"),this.uniforms=this.resources.twistUniforms.uniforms}get radius(){return this.uniforms.uTwist[0]}set radius(e){this.uniforms.uTwist[0]=e}get angle(){return this.uniforms.uTwist[1]}set angle(e){this.uniforms.uTwist[1]=e}get offset(){return this.uniforms.uOffset}set offset(e){this.uniforms.uOffset=e}get offsetX(){return this.offset.x}set offsetX(e){this.offset.x=e}get offsetY(){return this.offset.y}set offsetY(e){this.offset.y=e}};kr(Br,"DEFAULT_OPTIONS",{padding:20,radius:200,angle:4,offset:{x:0,y:0}});let Ll=Br;var kl=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
