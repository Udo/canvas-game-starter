...
var node = require('../external/gradient-parser/build/node.js');
var pixi_js = require('pixi.js');

function parseCssGradient(cssGradient) {
  const cssGradientNodes = node.parse(trimCssGradient(cssGradient));
...
exports.angleFromCssOrientation = angleFromCssOrientation;
exports.angleFromDirectionalValue = angleFromDirectionalValue;
exports.colorAsStringFromCssStop = colorAsStringFromCssStop;
exports.offsetsFromCssColorStops = offsetsFromCssColorStops;
exports.parseCssGradient = parseCssGradient;
exports.stopsFromCssStops = stopsFromCssStops;
exports.trimCssGradient = trimCssGradient;
exports.typeFromCssType = typeFromCssType;
//# sourceMappingURL=CssGradientParser.js.map
