	...
	create : async (prop = {}) => {
		...
		stage.init = async () => {
			...
			stage.updateMouseFromEvent = (e) => {
				...
				// Keep drag-scaled coordinates for camera/stage panning feel.
				stage.mouse.drag_x = stage.mouse.x * stage.mouse.drag_sensitivity;
				stage.mouse.drag_y = stage.mouse.y * stage.mouse.drag_sensitivity;
			};
			...
			stage.renderer.view.addEventListener('mousedown', (e) => {
				...
				stage.state.mouse = {
					x_down : stage.mouse.drag_x,
					y_down : stage.mouse.drag_y,
			...
			stage.renderer.view.addEventListener('mousemove', (e) => {
				...
				if(stage.state['mouse_button_'+stage.params.stage.drag_button] &&
					...
					stage.state.mouse.x_diff = (stage.mouse.drag_x-stage.state.mouse.x_down);
					stage.state.mouse.y_diff = (stage.mouse.drag_y-stage.state.mouse.y_down);
